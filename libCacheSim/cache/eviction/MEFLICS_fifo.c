...
static void MEFLIC_FIFO_parse_params(cache_t *cache,
                                     const char *cache_specific_params);
static void MEFLIC_FIFO_free(cache_t *cache);
static bool MEFLIC_FIFO_get(cache_t *cache, const request_t *req);
static cache_obj_t *MEFLIC_FIFO_find(cache_t *cache, const request_t *req,
 ...
 */
cache_t *MEFLIC_FIFO_init(const common_cache_params_t ccache_params,
                          const char *cache_specific_params) {
